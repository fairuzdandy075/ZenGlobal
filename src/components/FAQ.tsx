...
const FAQ = () => {
  ...
  const openWhatsApp = () => {
    ...
    const message = "Halo, saya ingin bertanya tentang program di Zen Global Language Institute";
        ...
        >
          <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl p-8 max-w-2xl mx-auto relative overflow-hidden">
            ...
            <button 
              ...
              className="bg-white text-orange-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 relative z-10 flex items-center justify-center mx-auto"
            >
